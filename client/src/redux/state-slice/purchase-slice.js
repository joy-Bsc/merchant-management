...
export const purchaseSlice = createSlice({
    ...
    reducers: {
        ...
        OnChangePurchaseInput: (state, action) => {
            state.PurchaseFormValues[`${action.payload.Name}`] = action.payload.Value;
        },
...
export const { SetPurchaseList, SetPurchaseListTotal,SetSupplierDropDown,SetProductDropDown,OnChangePurchaseInput,SetPurchaseItemList,RemovePurchaseItem  } = purchaseSlice.actions;
