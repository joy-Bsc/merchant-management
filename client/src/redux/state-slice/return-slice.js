...
export const returnSlice = createSlice({
    ...
    reducers: {
        ...
        OnChangeReturnInput: (state, action) => {
            state.ReturnFormValues[`${action.payload.Name}`] = action.payload.Value;
        },
...
export const { SetReturnList, SetReturnListTotal,SetCustomerDropDown,SetProductDropDown,OnChangeReturnInput,SetReturnItemList,RemoveReturnItem  } = returnSlice.actions;
